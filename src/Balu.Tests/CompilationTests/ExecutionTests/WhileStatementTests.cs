...
public partial class ExecutionTests
{
    ...
    public void Execute_WhileStatement_BasicallyWorks(string text, object? result) => text.AssertEvaluation(value: result);
    [Fact]
    public void Execute_WhileStatement_Reports_WrongConditionType()
    {
