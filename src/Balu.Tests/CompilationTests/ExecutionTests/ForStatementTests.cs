...
public partial class ExecutionTests
{
    ...
    public void Execute_ForStatement_BasicallyWorks(string text, object? result) => text.AssertEvaluation(value: result);
    [Fact]
    public void Execute_ForStatement_Reports_WrongBoundaryTypes()
    {
